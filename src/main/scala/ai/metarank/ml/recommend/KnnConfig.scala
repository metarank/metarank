...
object KnnConfig {
  ...
  given hnswDecoder: Decoder[HnswConfig] = Decoder.instance(c =>
    for {
  ...
  given hnswEncoder: Encoder[HnswConfig] = deriveEncoder

  given qdrantDecoder: Decoder[QdrantConfig] = deriveDecoder
  given qdrantEncoder: Encoder[QdrantConfig] = deriveEncoder

  given knnDecoder: Decoder[KnnConfig] = Decoder.instance(c =>
  ...
  given knnEncoder: Encoder[KnnConfig] = Encoder.instance {
